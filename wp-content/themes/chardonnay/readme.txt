...
Please install and activate it before starting to use the theme Chardonnay.
...
Theme documentation is available on http://chardonnay.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Chardonnay is Fontello.
