...
if ( ! function_exists( 'chardonnay_gutenberg_get_css' ) ) {
	add_filter( 'chardonnay_filter_get_css', 'chardonnay_gutenberg_get_css', 10, 2 );
	function chardonnay_gutenberg_get_css( $css, $args ) {
