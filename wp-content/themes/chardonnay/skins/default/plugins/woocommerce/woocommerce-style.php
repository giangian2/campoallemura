...
if ( ! function_exists( 'chardonnay_woocommerce_get_css' ) ) {
	add_filter( 'chardonnay_filter_get_css', 'chardonnay_woocommerce_get_css', 10, 2 );
	function chardonnay_woocommerce_get_css( $css, $args ) {
...
$fdir = chardonnay_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
